...
// const json = [
//   {
//   "product":"Fsdfasdfscof",
//   "price":"$106.87",
//   "category":"Living",
//   "color":"grey",
//   "size":"Large",
//   "producer":"Banshu Hamono"
//   },
//   {
//   "product":"Voyatouch",
//   "price":"$29.85",
...
function filter() {
  ...
  let isClickedDiv = [document.getElementById("acceptedArrowFirst"), document.getElementById('acceptedArrowSecond'), document.getElementById('acceptedArrowThird'), document.getElementById('acceptedArrowFourth'), document.getElementById('acceptedArrowFifth'), document.getElementById('sizeSmall'), document.getElementById('sizeMedium'), document.getElementById('sizeLarge'), document.getElementById("brandsFirst"),
  ...
  for (let i=0; i < isClickedDiv.length; i++) {
    if (i < color.length) {
      if (isClickedDiv[i].classList.contains("isClicked")) {
  ...
  document.getElementById("categoryFirstQuantity").innerHTML = priceCount + " at this price";
  ////////////////////////////////////////////////////////////////////////
